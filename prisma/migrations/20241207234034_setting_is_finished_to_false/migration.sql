...
CREATE TABLE "new_Project" (
    ...
    "isFinished" TEXT NOT NULL DEFAULT 'false',
    CONSTRAINT "Project_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_Project" ("companyId", "dateBegin", "dateEnd", "description", "funding", "id", "isFinished", "keyname", "name") SELECT "companyId", "dateBegin", "dateEnd", "description", "funding", "id", "isFinished", "keyname", "name" FROM "Project";
DROP TABLE "Project";
